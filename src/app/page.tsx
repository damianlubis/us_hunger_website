        ...
        <section className="relative pt-24 pb-32 px-6 overflow-hidden bg-gradient-to-b from-surface/50 to-white">
          ...
          <div className="max-w-7xl mx-auto flex flex-col items-center relative gap-12 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 w-full max-w-5xl mt-8">
              <div className="bg-white p-12 rounded-[2.5rem] shadow-2xl border border-slate-100 relative overflow-hidden group">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 items-center gap-20">
            <div className="space-y-10 group">
              ...
              <div className="grid grid-cols-2 gap-8 pt-6">
                <div className="p-8 border border-slate-100 rounded-3xl bg-surface/30 group-hover:bg-surface/50 transition-colors">
                  <div className="text-5xl font-black text-secondary mb-2 leading-none">{FISCAL_ADMIN_SHIFT}</div>
                  <div className="text-xs font-black text-slate-400 uppercase tracking-widest">New Admin Share</div>
                </div>
                <div className="p-8 border border-slate-100 rounded-3xl bg-surface/30">
                  <div className="text-5xl font-black text-danger mb-2 leading-none">6%</div>
                  <div className="text-xs font-black text-slate-400 uppercase tracking-widest">PER Penalty Threshold</div>
                </div>
              </div>
            </div>

            <div className="relative">
              <div className="absolute inset-0 bg-secondary/5 rounded-[3rem] -rotate-2 scale-105"></div>
              <div className="relative bg-white p-12 rounded-[3.5rem] shadow-2xl border border-slate-100 space-y-8 hover:scale-[1.02] transition-transform duration-500">
                <ShieldAlert className="w-12 h-12 text-secondary" />
                <h3 className="text-3xl font-black leading-tight tracking-tight text-primary">The &quot;PER Penalty&quot; Liability</h3>
                <p className="text-slate-500 text-lg leading-relaxed font-medium">
                  For the first time, states with a Payment Error Rate above 6% must pay actual benefit costs directly. This creates potential liabilities totaling millions for several major urban states.
                </p>
                <ul className="space-y-4 pt-4">
                  {[
                    "Massive system modernization requirements",
                    "Increased documentation frequency",
                    "State-level staff training burdens"
                  ].map((item, i) => (
